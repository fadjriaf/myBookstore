            ...
            $(document).ready(function() {
                ...
                $('#bukutable').DataTable( {
                    ...
                    buttons: [
                        {
                            extend: 'print',
                            title: 'myBookstore - Data Buku',
                            filename: 'myBookstore_-_Data_Buku',
                            exportOptions: {
                                columns: [ 0, 1, 2, 3, 4, 5 ]
                            }
                        },
                ...
                $('#distribtable').DataTable( {
                    dom: 'Bfrtip',
                    buttons: [
                        {
                            extend: 'print',
                            title: 'myBookstore - Data Distributor',
                            filename: 'myBookstore_-_Data_Distributor',
                            exportOptions: {
                                columns: [ 0, 1, 2 ]
                            }
                        },
                ...
                $('#pastable').DataTable( {
                    ...
                    buttons: [
                        {
                            extend: 'print',
                            title: 'myBookstore - Data Pasok',
                            filename: 'myBookstore_-_Data_Pasok',
                            exportOptions: {
                                columns: [ 0, 1, 2, 3 ]
                            }
                        },
